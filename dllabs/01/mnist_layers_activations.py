    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            for i in range(args.layers):
                hidden_layer = tf.layers.dense(hidden_layer, args.hidden_layer, activation=activation_func, name="hidden_layer_" + str(i))
            ...
            # compute and save the last computed accuracy
